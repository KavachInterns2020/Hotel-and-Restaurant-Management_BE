...
path('chef/history',views.food_history,name="food_history"),
path('chef/status',views.status,name='status'),
path('updatestatus/<str:pk>',views.updatestatus,name='updatestatus'),
path('fsremoveorder/<str:pk>',views.fsremoveorder,name='fsremoveorder'),
path('completeorder/<str:pk>',views.completeorder,name='completeorder'),
path('owner/viewrestaurantcustomers',views.viewrestaurantcustomers,name='viewrestaurantcustomers'),
path('owner/viewrestaurantbills',views.viewrestaurantbills,name='viewrestaurantbills'),
]
