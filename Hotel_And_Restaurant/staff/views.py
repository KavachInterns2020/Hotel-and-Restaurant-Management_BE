...
def chef(request):
	...
	if completed < 0:
		completed=0
	return render(request,'chef_dashboard.html',{'foodservices':foodservices,'active':active,'completed':completed,'total':total})
...
def food_history(request):
	...
	if completed < 0:
		completed=0
	return render(request,'view_food_history.html',{'foodservices':foodservices,'active':active,'completed':completed,'total':total})
